...
// Returns the private 'App\Repository\ComptRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComptRepository.php';

return $this->privates['App\\Repository\\ComptRepository'] = new \App\Repository\ComptRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
