...
class Partenaire
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Compt", mappedBy="partenaire")
     */
    private $compts;
    ...
    public function addCompt(Compt $compt): self
    {
    ...
    public function removeCompt(Compt $compt): self
    {
        if ($this->compts->contains($compt)) {
